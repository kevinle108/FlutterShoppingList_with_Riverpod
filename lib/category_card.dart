    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => CategroryScreen(itemName: itemName,)));
            },
            child: Row(
              children: [
                CircleAvatar(
          ...
          IconButton(
            ...
            onPressed: () {
              showDialog(
                context: context,
                builder: (context) {
                  return EditListCard(itemName: itemName, itemPriority: itemPriority,);
                },
              );
            },
          ),
